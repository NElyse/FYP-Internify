                  ...
                  <table class="table text-nowrap mb-0 align-middle datatable-1 table table-bordered table-striped" id="data">
                    ...
                    <tbody>
                      ...
                      foreach (proj::check_applied($_SESSION['userid']) as $value) {
                        $data=proj::company_reports($value['stu_id'],'Evaluation_form');
                          ...
                          <div class="d-flex align-items-center gap-2">
                            <?php if ($app==1) {
                              ?>
                               ...
                               <button class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#Evaluation_form_<?php echo $value['stu_id'];?>"> Add</button>
                               <?php
                            }
                            else{

...
<!-- start -->
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Classes and Promotions at <?php echo $_SESSION['sc_name'];?></h5>
              <button type="button" class="btn btn-primary m-1" data-bs-toggle="modal" data-bs-target="#levels">Regist new</button>
                  ...
                  <table class="table text-nowrap mb-0 align-middle datatable-1 table table-bordered table-striped" id="data">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <button class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#editlevel_<?php echo $value['lev_id'];?>">Modify</button></a>
                        </td>
                      </tr> 
                      <?php
